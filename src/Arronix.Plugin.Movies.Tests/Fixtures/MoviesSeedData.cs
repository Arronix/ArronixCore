...
public static class MoviesSeedData
{
    ...
    [
        new()
        {
            ...
            Year = 2001,
            Status = MovieReleaseStage.Released,
        ...
        new()
        {
            ...
            Year = 2026,
            Status = MovieReleaseStage.InCinemas,
        ...
        new()
        {
            ...
            Year = 2027,
            Status = MovieReleaseStage.Announced,
        ...
        new()
        {
            ...
            Year = 2019,
            Status = MovieReleaseStage.Released,
            CatalogState = CatalogRecordState.Withdrawn,
