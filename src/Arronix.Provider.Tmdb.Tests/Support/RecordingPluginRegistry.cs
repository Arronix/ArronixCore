...
internal sealed class RecordingPluginRegistry : IPluginRegistry
{
    ...
    {
        var registration = ProviderTypeRegistration.ForCataloger<TCataloger>(descriptor);
        Catalogers.Add((registration.MediaItemType!, typeof(TCataloger), descriptor));
        return this;
    }
    ...
    {
        var registration = ProviderTypeRegistration.ForCurator<TCurator>(descriptor);
        Curators.Add((registration.MediaItemType!, typeof(TCurator), descriptor));
        return this;
    }
