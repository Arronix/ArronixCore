...
public class HttpRequestBuilder(string baseUrl)
{
    public HttpMethod Method { get; set; } = HttpMethod.Get;
    public HttpAccept HttpAccept { get; set; }
    public HttpUri BaseUrl { get; private set; } = new HttpUri(baseUrl);
    public string ResourceUrl { get; set; } = string.Empty;
    public List<KeyValuePair<string, string>> QueryParams { get; private set; } = new List<KeyValuePair<string, string>>();
    public List<KeyValuePair<string, string>> SuffixQueryParams { get; private set; } = new List<KeyValuePair<string, string>>();
    public Dictionary<string, string> Segments { get; private set; } = new Dictionary<string, string>();
    public HttpHeader Headers { get; private set; } = new HttpHeader();
    public bool SuppressHttpError { get; set; }
    public IEnumerable<HttpStatusCode> SuppressHttpErrorStatusCodes { get; set; }
    public bool LogHttpError { get; set; } = true;
    ...
    public List<HttpFormData> FormData { get; private set; } = new List<HttpFormData>();
    ...
    public virtual HttpRequestBuilder Clone()
    {
        ...
        clone.QueryParams = [.. clone.QueryParams];
        clone.SuffixQueryParams = [.. clone.SuffixQueryParams];
